<?php
   ...
   if(isset($_POST["register"]))
   {
       ...
       {
          $trainingof_error = "Select Your Training Choice";
       }
       else 
       {
       ...
       {
        $startdate_error ="Please Enter Starting Date";
       }
       else
       {
       ...
       //Enter To Database
       if(!empty($name) && !empty($email) ** !empty($age) && !empty($qualification) && !empty($address) && !empty($mobile) && !empty($trainingof) && !empty($startdate))
       {
        ...
        $sql = "INSERT INTO training (name, email,age, qualification,address, gender, mobile,trainingof,startdate,registerdate) VALUES ('$name','$email','$age','$qualification','$address','$gender','$mobile','$trainingof','$startdate','$regdate')";
...
<label>Training Of</label>
    </div>
<div class="training-cols">
<h6><?php echo $startdate_error; ?></h6>
<input type="text" name="startdate" placeholder="Enter Start Date" value='<?php echo $startdate; ?>'>
